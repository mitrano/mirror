...
| `python -m memory web` | — | — | Runs the local Mirror Web Console — read-only Identity and Workspace perspectives, conversation intelligence, and allowlisted operation runs | `[--host 127.0.0.1] [--port 8765]` |
