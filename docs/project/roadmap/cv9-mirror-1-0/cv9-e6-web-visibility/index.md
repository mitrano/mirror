...
|------|-------|----------------------|--------|
| [CV9.E6.S1](cv9-e6-s1-web-surface-foundation/index.md) | Web Surface Foundation | The core exposes typed read models for Atlas, Workspace, object detail, evidence, and search without web routes querying internal data directly | 🟡 Planned |
| [CV9.E6.S2](cv9-e6-s2-perspective-shell/index.md) | Perspective Shell and Preference | The local web app lets the user choose Atlas or Workspace, stores the default in the user home, and keeps a stable shell across perspectives | 🟡 Planned |
