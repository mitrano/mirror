...
|------|------|----------------------|--------|
| CV13.E1 | Read-only Web Refinement | Workspace opens first, the shell is calmer, Identity and journey views expose better chips, totals, memory/search pages, and conversation cards without task noise | 🟡 Planned |
