...
|------|-------|------|---------|--------|
| [CV20.DS5.US1](cv20-ds5-us1-choose-navigator-flow-unit/index.md) | Choose Navigator Flow Unit | User Story | Navigator can choose story-by-story or delivery-story lifecycle cadence after DS expansion | 🟡 Planned |
