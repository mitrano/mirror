...
|------|-------|------|---------|--------|
| [CV20.DS6.US1](cv20-ds6-us1-builder-home-work-fields/index.md) | Builder Home Work Fields | User Story | Navigator sees current Delivery and Refinement fields during Builder activation, including roadmap state, workbench summary, active RS, and available moves | 🟡 Planned |
